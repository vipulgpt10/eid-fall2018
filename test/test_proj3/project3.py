...
class project1(QDialog):
    def __init__(self, parent=None):
        ...
        mqtt_client.connect()
        mqtt_client.publish("RpiPolicy", "connected", 0)
        ...
        try:
            ...
            if temp is None and humidity is None:
               ...
               connection_flag = 1
                ...
                temp_message = "TempC;"+str(round(temp,2))+";"+str(round(max(temp_list),2))+";"+str(round(min(temp_list),2))+";"+str(round(temp_avg,2))+";"+today+";"
                print("{}".format(temp_message))
                mqtt_client.publish("RpiPolicy", temp_message, 0)
                temp_message = "TempF;"+str(round(temp_f,2))+";"+str(round(temp_f_high,2))+";"+str(round(temp_f_low,2))+";"+str(round(temp_avg_f,2))+";"+today+";"
                print("{}".format(temp_message))
                mqtt_client.publish("RpiPolicy", temp_message, 0)
        ...
        try:
            ...
            if temp is None and humidity is None:
               ...
               print("***********Connection removed**************")
                ...
                #send data to aws cloud
                hum_message = "Hum;"+str(round(humidity,2))+";"+str(round(max(hum_list),2))+";"+str(round(min(hum_list),2))+";"+str(round(hum_avg,2))+";"+today+";"
